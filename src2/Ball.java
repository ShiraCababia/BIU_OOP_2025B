...
public class Ball implements Sprite {
    ...
    /**
     * Constructor.
     * Initializes a ball at the given center point, with the specified radius and
     * color.
     *
    ...
    public void moveOneStep() {
        ...
        if (impact == null) {
            ...
            Collidable obj = impact.collisionObject();
            Velocity updatedVelocity;
            if (obj instanceof Block) {
                updatedVelocity = ((Block) obj).hit(this, hitPoint, velocity);
            } else {
                updatedVelocity = obj.hit(hitPoint, velocity); // fallback
            }
